...
""",{
  ...
  def onSaveButton(self,code):
    conf = Configuration(path='',arch=ida_idp.get_idp_name()+'64',
                              emulator='unicorn',
  ...
  def fillconfig(conf=None):
      ...
      if ok:
          ...
          ret = Configuration(path=f.conf_path, arch=ida_idp.get_idp_name(),
                              ...
                              registers=x64Registers(f.RAX.value,f.RBX.value,f.RCX.value,f.RDX.value,
                                           f.RDI.value,f.RSI.value,f.R8.value,f.R9.value,f.R10.value,f.R11.value,f.R12.value,f.R13.value,f.R14.value,f.R15.value,f.RBP.value,f.RSP.value,f.RIP.value),
