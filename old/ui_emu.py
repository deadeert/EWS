...
#     conf_apath = '/tmp/idaemu_conf_'+time.ctime().replace(' ','_')
  ...
  def cb_callback(self,fid):
    ...
    elif fid == self.istkSize or fid == self.iStkBA:
  ...
  def fillconfig():
      ...
      if ok:
          ...
          ret = Configuration(ida_idp.get_idp_name(),
                              f.iPageSize.value,
                              f.iStkBA.value,
                              f.iStkSize.value,
                              f.cAGrp.value,
...
""",{
  ...
  def onSaveButton(self,code):
    conf = Configuration(ida_idp.get_idp_name(),
                              self.GetControlValue(self.iPageSize),
                              self.GetControlValue(self.iStkBA),
                              self.GetControlValue(self.iStkSize),
                              self.GetControlValue(self.cAGrp),
                              self.GetControlValue(self.cRGrp),
