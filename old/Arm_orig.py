...
class UnicornHelper(object):
  ...
  def mem_read(self,addr,size):
    return self.runner.mem_read(addr,size)
  def mem_write(self,addr,data):
    self.runner.mem_write(addr,data)
  def reg_read(self,reg_id):
    return self.runner.reg_read(emucorn.Emucorn.reg_convert(reg_id))
  def reg_write(self,reg_id,data):
    return self.runner.reg_write(emucorn.Emucorn.reg_convert(reg_id),data)
